...
const AboutMe = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 grid-rows-4 gap-y-8 pb-36">
        {/* Row 1, Col 1 */}
        ...
        {/* Row 1, Col 2 */}
        <div className=" min-h-[20vh] text-center flex items-center justify-center col-start-2 row-start-1"></div>
        {/* Row 2, Col 1 */}
